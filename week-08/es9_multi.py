...
data4 = genfromtxt('es9_vg4')
xdata4 = data4[:,0]
ydata4 = data4[:,1]

data3 = genfromtxt('es9_vg3')
xdata3 = data3[:,0]
ydata3 = data3[:,1]

data2 = genfromtxt('es9_vg2')
xdata2 = data2[:,0]
ydata2 = data2[:,1]
#zdata = sfasa
#sigmay = ydata1/100
...
plot(xdata4, ydata4, linestyle="None",marker=".", color="black", markersize= 10, label=r'$V_G = 4V$')
...
##
savefig('es9_multivg.png', dpi=400)
show()
