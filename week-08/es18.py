...
#plot(xdata1, ydata1, linestyle="None",marker=".", color="blue", markersize= 10)
title(r"Tensione anodo LED $V_{a}$ in funzione di $V_{in}$", size = 15)
...
##
savefig('es18_log_prova1.png', dpi=400)
show()
