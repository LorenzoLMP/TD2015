...
data = genfromtxt('planck_constant_20ua.txt')
...
title(r"Planck Constant fit 20$\mu$A") 

xlabel(r'$\lambda^{-1}  [nm^{-1}]$')
ylabel(r'$\frac{qV_{F}}{c} [J]$')
ax = axes()
savefig('costante_planck_20ua.png', dpi=400)

out_file = open("planck_newdata_20ua.txt","w")
