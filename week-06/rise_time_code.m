...
c = polyfit(y'(:,1), y'(:,2), 25);x1 = linspace(2.1, 2.5, 500); 
z = polyval(c, x1); c(26) = c(26) - 0.0094;roots(c);

z = polyval(c, x1);plot(a'([40:60],1), a'([40:60],2), 'o-r', x1, z)
lin = interp1(a'([40:60],1)/1000000, a'([40:60],2), [a'(40,1):