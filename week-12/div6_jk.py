...
q1 = 0
q2 = 0
out_file = open("divisore_sei_3va_in2.txt","w")
out_file.write("j1\tk1\tj2\tk2\tj3\tk3\tq1\tq2\tq3")
for i in range(len(clock)):
    a1 = jk(clock[i], neg(q1), 1, q0)
    #x = c*q0
    #y = neg(c)*neg(q0)
    a2 = jk(clock[i], q0, 1, q1)
    #z = x*q1
    #w = y*neg(q1)
    a3 = jk(q1, 1, 1, q2)
##  a4 = jk(clock[i], q2*q0*q1, q2*q0*q1, q3)
    ...
    a3 = [a2[2], a2[2], a3[2]]
##  a4 = [a2[2]*a1[2]*a3[2], a2[2]*a1[2]*a3[2], a4[2]]
    print(a1[0], a1[1], a2[0], a2[1], a3[0], a3[1], a1[2], a2[2],a3[2])
    out_file.write("\n%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s"%(a1[0], a1[1], a2[0], a2[1], a3[0], a3[1], a1[2], a2[2],a3[2]))
    q0 = a1[2]
    q1 = a2[2]
    q2 = a3[2]
##  q3 = a4[2]
