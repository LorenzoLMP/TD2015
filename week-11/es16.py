...
title(r"Divisore per tre - simmetrizzato", size = 15)
grid('on', which = "both")
errorbar(xdata, ydata1, 0.01, 0.000005, color="black")
errorbar(xdata, ydata2, 0.01, 0.000005, color="red")
#xscale('log')
xlim(-0.2,30.2)
#xlim(-1,16)
#xscale('log')
...
##
savefig('es16_conline.png', dpi=400)
show()
