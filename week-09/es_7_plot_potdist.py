...
data = genfromtxt('es7_pot_dist.txt')
...
def fitfunc(x, *par): 
	return par[0]/((x-par[1])**(2)) 

p0 = [40000,-0.05] #metti il valore inizialeee
...
text(75, 0.35, chiquadro, family='serif', style='italic', size=15) 
text(75, 0.32, degfreedom, family='serif', style='italic', size=14)
...
grid('on', which = "both")
ax = axes()
savefig('es7_fit_fissexp.png', dpi=400)
