...
p0 = [1,4] #metti il valore inizialeee
...
ax1.text(1, 1.5, chiquadro, family='serif', style='italic', size=15) 
ax1.text(1, 1, degfreedom, family='serif', style='italic', size=14)
...
ax1.set_ylabel(r'Corr. max $ I_{max} $ [mA]', color='r')
for tl in ax1.get_yticklabels():
    tl.set_color('r') 
grid('on', which = "both")
#ax = axes()
savefig('es8_fit_corr.png', dpi=400)
