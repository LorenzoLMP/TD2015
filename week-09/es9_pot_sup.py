...
title(r"Potenza max in funzione della sup esposta", size = 15)

#ax1.errorbar(sup_exp, vmax, 0.0003, sigmapmax, linestyle="None", color="black")
ax1.plot(sup_exp, pmax, linestyle="None", marker="o", markersize =8, color="black")
...
ax1.set_ylabel(r'Potenza max $P_{max}$ [mW]', color='black')
...
grid('on', which = "both")
savefig('es_9pot_sup.png', dpi=400)
